...
- name: No Title - DELETE Bucket Metrics
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/watch/master/_listings/aws-s3/metricsampidid-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/watch/master/_listings/aws-s3/metricsampidid-delete-openapi.md
- name: No Title - PUT Bucket Metrics
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/watch/master/_listings/aws-s3/metricsampidid-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/watch/master/_listings/aws-s3/metricsampidid-put-openapi.md
- name: No Title - GET Bucket Metrics
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/watch/master/_listings/aws-s3/metricsampidid-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/watch/master/_listings/aws-s3/metricsampidid-get-openapi.md
x-common:
- type: x-api-gallery
